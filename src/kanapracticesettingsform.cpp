...
KanaPracticeSettingsForm::KanaPracticeSettingsForm(QWidget *parent) : base(parent, false), ui(new Ui::KanaPracticeSettingsForm), updating(false), hiracheckcnt(0), katacheckcnt(0)
{
    ...
    connect(hiramap, &QSignalMapper::mappedInt, this, &KanaPracticeSettingsForm::boxToggled);
    ...
    connect(katamap, &QSignalMapper::mappedInt, this, &KanaPracticeSettingsForm::boxToggled);
    ...
    connect(stackmap, &QSignalMapper::mappedInt, ui->stack, &QStackedWidget::setCurrentIndex);
